...
!(function(a, b) {
	...
	var x = (function(a) {
		var b,
			...
			ca = function(a, b) {
				return b
					? '\x00' === a ? '\ufffd' : a.slice(0, -1) + '\\' + a.charCodeAt(a.length - 1).toString(16) + ' '
					: '\\' + a;
			},
			da = function() {
				m();
		...
		r.each([ 'height', 'width' ], function(a, b) {
			r.cssHooks[b] = {
				...
				set: function(a, c, d) {
					...
					return (
						g && (e = _.exec(c)) && 'px' !== (e[3] || 'px') && ((a.style[b] = c), (c = r.css(a, b))),
						Ua(a, c, g)
					);
				}
			};
			...
			attr: function(a, b, c) {
				...
				if (3 !== f && 8 !== f && 2 !== f)
					return 'undefined' == typeof a.getAttribute
						? r.prop(a, b, c)
						: ((1 === f && r.isXMLDoc(a)) ||
								(e = r.attrHooks[b.toLowerCase()] || (r.expr.match.bool.test(b) ? Xa : void 0)),
							void 0 !== c
								? null === c
